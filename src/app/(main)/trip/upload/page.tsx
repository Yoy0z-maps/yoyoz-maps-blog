...
export default function TripUploadPage() {
  return (
    <main className="relative min-h-[100svh] w-full overflow-hidden bg-[#f5ede4] bg-[linear-gradient(180deg,rgba(255,255,255,0.72),rgba(255,255,255,0.94))] px-4 pb-44 pt-8 transition-colors duration-500 dark:bg-[#050505] dark:bg-[linear-gradient(180deg,rgba(3,3,3,0.7),rgba(3,3,3,0.94))] sm:px-8 sm:pt-10 lg:pt-32 lg:px-10">
