...
export default function TripPage() {
  return (
    <main className="trip-page relative h-[100svh] w-full overflow-hidden transition-colors duration-500">
      ...
      <Link href="/trip/manage" className="absolute bottom-28 left-8 z-30 rounded-full bg-white/90 px-5 py-3 text-sm font-bold text-slate-800 dark:bg-neutral-900 dark:text-white md:bottom-8">사진 관리</Link>
      <Link
