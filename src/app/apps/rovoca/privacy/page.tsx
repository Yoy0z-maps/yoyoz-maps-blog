...
export default function PrivacyPage() {
  return (
    <AppPrivacyPage app={app} effectiveDate="2025-06-03" contentLang="en">
      <div>
        <p>
          This privacy policy applies to the ROVOCA app (hereby referred to as
          &quot;Application&quot;) for mobile devices that was created by
          Yoy0z-maps (hereby referred to as &quot;Service Provider&quot;) as an
          Ad Supported service. This service is intended for use &quot;AS
          IS&quot;.
        </p>
        ...
        <p>
          ...
          work.johnhan@gmail.com and they will respond in a reasonable time.
        </p>
        ...
        <p>
          ...
          the Service Provider (work.johnhan@gmail.com) so that they will be
        ...
        <p>
          If you wish to delete your account and the data associated with it,
          you can do so directly within the Application. Go to the &quot;My
          Page&quot; section and tap the &quot;Delete Account&quot; button. This
          will permanently remove your account and all related data from our
          servers.
        </p>
        ...
        <p>
          ...
          Service Provider via email at work.johnhan@gmail.com.
        </p>
        <hr />
        <p>
